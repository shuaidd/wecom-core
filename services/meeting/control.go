...
func (s *Service) KickoutUsers(ctx context.Context, req *meeting.KickoutUsersRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/kickout_users", req)
	return err
}
...
func (s *Service) SetNicknames(ctx context.Context, req *meeting.SetNicknamesRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/set_nicknames", req)
	return err
}
...
func (s *Service) MuteUser(ctx context.Context, req *meeting.MuteUserRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/mute_user", req)
	return err
}
...
func (s *Service) Dismiss(ctx context.Context, req *meeting.DismissMeetingRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/dismiss", req)
	return err
}
...
func (s *Service) SetCohost(ctx context.Context, req *meeting.SetCohostRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/set_cohost", req)
	return err
}
...
func (s *Service) SetMeetingSettings(ctx context.Context, req *meeting.MeetingSettingsRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/set", req)
	return err
}
...
func (s *Service) ManageWaitingRoomUsers(ctx context.Context, req *meeting.ManageWaitingRoomUsersRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/manage_waiting_room_users", req)
	return err
}
...
func (s *Service) SwitchUserVideo(ctx context.Context, req *meeting.SwitchUserVideoRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/switch_user_video", req)
	return err
}
...
func (s *Service) CloseScreenShare(ctx context.Context, req *meeting.CloseScreenShareRequest) error {
	_, err := client.PostAndUnmarshal[client.CommonResponse](s.client, ctx, "/cgi-bin/meeting/realcontrol/close_screen_share", req)
	return err
}
